...
XSUM_KWARGS = dict(beam=6, lenpen=0.1, max_len_b=50, min_len=1, no_repeat_ngram_size=3)
...
def generate(bart, infile, outfile="bart_hypo.txt", bsz=32, n_obs=None, **eval_kwargs):
    ...
    with open(infile, encoding='utf8') as source, open(outfile, "w", encoding='utf8') as fout:
